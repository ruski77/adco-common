...
import static adcowebsolutions.dao.hibernate.HibernateUtil.isEntityIdManuallyAssigned;
...
public abstract class HibernateGenericDao<E extends Identifiable<PK>, PK extends Serializable> implements GenericDao<E, PK> {
    ...
    public void save(E entity) {
        ...
        // the simple fact to invoke this @Transactional method does the job
    }
    ...
    public void update(E entity) {
        Validate.notNull(entity, "The entity to update cannot be null element");
